 ...
 * });
 */
const Chunk = require('mongodb/lib/gridfs/chunk');
const ObjectID = require('mongodb/lib/core').BSON.ObjectID;
...
const shallowClone = require('mongodb/lib/utils').shallowClone;
const executeLegacyOperation = require('mongodb/lib/utils').executeLegacyOperation;
