...
const Logger = require('mongodb/lib/core').Logger;
const MongoCredentials = require('mongodb/lib/core').MongoCredentials;
const MongoError = require('mongodb/lib/core').MongoError;
const Mongos = require('mongodb/lib/topologies/mongos');
const NativeTopology = require('mongodb/lib/topologies/native_topology');
const parse = require('mongodb/lib/core').parseConnectionString;
const ReadConcern = require('mongodb/lib/read_concern');
const ReadPreference = require('mongodb/lib/core').ReadPreference;
const ReplSet = require('mongodb/lib/topologies/replset');
const Server = require('mongodb/lib/topologies/server');
const ServerSessionPool = require('mongodb/lib/core').Sessions.ServerSessionPool;
const emitDeprecationWarning = require('mongodb/lib/utils').emitDeprecationWarning;
const fs = require('fs');
const BSON = require('mongodb/lib/core/connection/utils').retrieveBSON();
const CMAP_EVENT_NAMES = require('mongodb/lib/cmap/events').CMAP_EVENT_NAMES;

let client;
function loadClient() {
  if (!client) {
    client = require('mongodb/lib/mongo_client');
  }
  return client;
}

const legacyParse = deprecate(
  require('mongodb/lib/url_parser'),
...
function createTopology(mongoClient, topologyType, options, callback) {
  ...
  if (options.autoEncryption != null) {
    ...
    try {
      ...
      AutoEncrypter = mongodbClientEncryption.extension(require('mongodb')).AutoEncrypter;
    } catch (err) {
      callback(err);
      return;
    }
