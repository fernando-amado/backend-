...
var inherits = require('util').inherits,
  ...
  debugOptions = require('mongodb/lib/core/connection/utils').debugOptions,
  retrieveBSON = require('mongodb/lib/core/connection/utils').retrieveBSON,
  Pool = require('mongodb/lib/core/connection/pool'),
  MongoError = require('mongodb/lib/core/error').MongoError,
  MongoNetworkError = require('mongodb/lib/core/error').MongoNetworkError,
  wireProtocol = require('mongodb/lib/core/wireprotocol'),
  CoreCursor = require('mongodb/lib/core/cursor').CoreCursor,
  sdam = require('mongodb/lib/core/topologies/shared'),
  createCompressionInfo = require('mongodb/lib/core/topologies/shared').createCompressionInfo,
  resolveClusterTime = require('mongodb/lib/core/topologies/shared').resolveClusterTime,
  SessionMixins = require('mongodb/lib/core/topologies/shared').SessionMixins,
  relayEvents = require('mongodb/lib/core/utils').relayEvents;

const collationNotSupported = require('mongodb/lib/core/utils').collationNotSupported;
