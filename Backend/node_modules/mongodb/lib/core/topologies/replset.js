...
const ReadPreference = require('mongodb/lib/core/topologies/read_preference');
const CoreCursor = require('mongodb/lib/core/cursor').CoreCursor;
const retrieveBSON = require('mongodb/lib/core/connection/utils').retrieveBSON;
const Logger = require('mongodb/lib/core/connection/logger');
const MongoError = require('mongodb/lib/core/error').MongoError;
const Server = require('mongodb/lib/core/topologies/server');
const ReplSetState = require('mongodb/lib/core/topologies/replset_state');
const Timeout = require('mongodb/lib/core/topologies/shared').Timeout;
const Interval = require('mongodb/lib/core/topologies/shared').Interval;
const SessionMixins = require('mongodb/lib/core/topologies/shared').SessionMixins;
const isRetryableWritesSupported = require('mongodb/lib/core/topologies/shared').isRetryableWritesSupported;
const relayEvents = require('mongodb/lib/core/utils').relayEvents;
const BSON = retrieveBSON();
const getMMAPError = require('mongodb/lib/core/topologies/shared').getMMAPError;
const makeClientMetadata = require('mongodb/lib/core/utils').makeClientMetadata;
const legacyIsRetryableWriteError = require('mongodb/lib/core/topologies/shared').legacyIsRetryableWriteError;
const now = require('mongodb/lib/utils').now;
const calculateDurationInMs = require('mongodb/lib/utils').calculateDurationInMs;
